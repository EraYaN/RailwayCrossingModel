...
\cref{tb:sensorSignals} shows the interactions of the sensor controller with the sensor aggregator and the sensors.
...
trainon & & Debug signal meaning a train is on the tracks \\
trainoff & & Debug signal meaning there is no train on the tracks\\\hline
\end{tabular}
