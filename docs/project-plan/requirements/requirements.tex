...
\section{System Components} %TODO[c]: establish a notation for each component
\begin{itemize}
\item 2 train tracks
...
\item A train can arrive on both tracks from both directions.
	...
	\item Theoretically, it would be possible for two trains to arrive from the same direction where one of the trains is significantly shorter than the other one. %TODO: = Challenging Cases?
	\end{enumerate}
